 ...
 * @author kevin
 */
public class PesquisaDistribuicaoDoRankingController extends HttpServlet {
     ...
     */
       protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("ranking", Ranking.obterRanking(codRanking));
            String tipoLogin = request.getParameter("tipoLogin");
            request.setAttribute("tipoLogin", tipoLogin);
            RequestDispatcher view = request.getRequestDispatcher("/pesquisaDistribuicaoDoRanking.jsp");
